        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto text-center d-flex justify-content-center align-items-center">
              <Nav.Link href="#home" className='text-secondary fw-bold'>Inicio</Nav.Link>
              <Nav.Link href="#home" className='text-secondary fw-bold'>Acerca de Nosostros</Nav.Link>
              <Nav.Link href="#home" className='text-secondary fw-bold'>Contactanos</Nav.Link>
              <Nav.Link href="#home" className='text-secondary fw-bold'>Testimonios</Nav.Link>
